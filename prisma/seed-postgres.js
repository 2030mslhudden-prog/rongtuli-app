...
// Initialize Prisma with PostgreSQL - the DATABASE_URL env var will be used
...
async function main() {
  console.log('Starting seed for PostgreSQL (Neon) database...');
  ...
  try {
    ...
    if (!adminUser) {
      ...
      adminUser = await prisma.user.update({
        ...
        data: { 
          role: 'ADMIN',
          name: adminUser.name || 'Rongtuli Super Admin',
        },
      });
    ...
    console.log(`✓ Sample products: ${productCount} items synced`);
    console.log('');
