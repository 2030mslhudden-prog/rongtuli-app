            ...
            <div className="bg-surface-container-lowest border border-amber-200 rounded-2xl p-6 shadow-sm text-left">
              ...
              <div className="flex justify-center mt-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-16 h-16 bg-[#25D366] text-white rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all flex items-center justify-center"
                  title="হোয়াটস্যাপে মেসেজ দিন"
                >
                  <svg className="w-9 h-9 fill-current ml-0.5 mt-0.5" viewBox="0 0 24 24">
