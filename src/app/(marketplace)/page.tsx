...
const featuredCards = [
  ...
  { title: "Brand Strategy Deck", price: "$21", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuD9vJ2h0m-7bNYnDgRjKc5WJe7N2pm3kyrb3_2sM0s3wV3t1Bq4JmI5YNvJbS1bgYb1M7cpwZQCHCaXH0-9YwS1RzW11M6i74Baf1jMJg91k3I8m2IYbjm677rPNtP2g2-Kh7psuYg7r7jvGmMWAaru1s-UO7z4GYjn7d4vVhP_i6-Lp3JZg7J1T7nSVz0dM2mlyw-6x7nDg" },
  { title: "Poster System Kit", price: "$16", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuA6V3YBqsj-Nn5-8PgTw0qWljmJkWqvV7T4h86AeI7lZq4U8J5qG9QDP0VdRvbJ7-bY8VgEoZu0nQr1S1MrHqsRcLxJbpxM4Q0t5hE9VgY6rOC6aYHDeq5YCV2Ir0B1Yj5F0v3d7S7A1_h3nFQ8rM2nCJx9jPv0nMj4Hkk01AImwXGmiq5S5e0m5JbYIeKp3v3ZQdG8U" },
];
            ...
            <div className="scroll-track-container">
              <div className="scroll-track">
                {[...uiKitCards, ...uiKitCards].map((card, index) => (
                  <Link key={`${card.title}-${index}`} href="#" className="group block w-[300px] flex-shrink-0 relative overflow-hidden rounded-2xl bg-surface-container-lowest shadow-sm transition-all duration-500 hover:scale-105 hover:shadow-sm">
        ...
        <section className="py-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto bg-surface-container-lowest rounded-[2rem] shadow-sm my-12 animate-fade-in-up-delay-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 space-y-0">
            {featuredCards.map((card) => (
              <div key={card.title} className="group relative flex flex-col gap-4 transition-all duration-500 group-hover:scale-105 group-hover:shadow-[0_10px_25px_rgba(27,107,75,0.12)]">
